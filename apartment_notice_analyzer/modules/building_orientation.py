...
# 향별 선호도 — 실제 감정평가서 2건(오산세교 쌍용예가NHF, 화성남양 시티프라디움3차,
# 둘 다 2024 분양전환 감정평가) 채택값 + 인용 선행연구 대조로 보정한 값이다.
# 과거 placeholder(북=0.88)는 격차를 크게 과대추정했다 — 실무에서 채택되는 격차는
# 훨씬 작다. 남동/남서 간 실제 채택 격차는 0.998~1.000로 사실상 무시할 수준.
#
# 근거:
#   - 오산세교 쌍용예가NHF 감정평가서(가람감정평가법인, 2023): 남동향 1.000,
#     남서향 0.995(위치별요인에 흡수됨). 실제 결정치는 0.998~1.000.
#   - 화성남양 시티프라디움3차 감정평가서(미래새한/하나감정평가법인, 2024)
#     인용 선행연구:
#       정기영(2001) 「아파트 동일단지내 세대별 효용격차 및 분양가 산정방법에 관한 연구」
#         — 남향기준 100 대비 동향 95.22, 서향 86.42 (주택산업연구원)
#         — 남향대비 로얄층기준100 대비 동남향 98.86, 동향/남서향 95.95, 서향/북향 94.27 (대한주택공사)
#         — 한국감정원: 동향 -4~-5.3%, 서향 -5~-7.5%
#         — LG건설 영업부(서울 분양권 전매추이): 향별 10% 차이
# 북향은 직접 관측치가 없어 대한주택공사 "서향/북향" 묶음(94.27)을 상한으로 삼아
# 위 연구들의 하한(-10%대)까지 함께 고려한 보수적 절충값이다 — 임장으로 반드시 재확인할 것.
PREFERENCE = {"남": 1.00, "남동": 1.00, "남서": 0.998, "동": 0.95,
              "서": 0.90, "북동": 0.945, "북서": 0.92, "북": 0.90}
